...
#     sd_name: str = "stabilityai/stable-diffusion-xl-base-1.0"
...
image = image.run_function(initiate_sdxl, )
...
volume = Volume.from_name(
    "pixi-plot-volume", create_if_missing=True
)
MODEL_DIR = "/model"
